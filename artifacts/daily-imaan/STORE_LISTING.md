# Daily Imaan — Store Listing Copy
...
- **App Store secondary:** Reference
- **Play Store category:** Lifestyle

## Age rating

- **App Store:** 4+
- **Play Store:** Everyone (Rated for 3+)
...
Both stores require screenshots for the largest device size in each family. Capture from a real device or simulator running the production build (NOT the dev preview).

### iOS — required device sizes

| Size | Pixel dimensions | Devices |
| --- | --- | --- |
| 6.9" | 1290 × 2796 | iPhone 16 Pro Max / 15 Pro Max |
| 6.5" | 1242 × 2688 or 1284 × 2778 | iPhone XS Max, 11 Pro Max, etc. |
| 5.5" | 1242 × 2208 | iPhone 8 Plus _(only required if your binary supports < iOS 13)_ |

Submit at minimum the 6.9" set. 3–10 screenshots per size.

### Android — required device sizes

- Phone screenshots: 1080 × 1920 minimum, 2 to 8 images.
